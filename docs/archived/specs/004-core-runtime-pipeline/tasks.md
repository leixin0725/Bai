...
**Independent Test**: 对照 `../../Scriptor_to_Bai_migration/archived/feature-checklist.md` 第 4/12 节与 `../../Scriptor_to_Bai_migration/archived/future-and-discarded.md` 第 4 节原文。
