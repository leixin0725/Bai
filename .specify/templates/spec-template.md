...
<!--
  Identify the business decisions and invariants that implementation MUST preserve.
  Describe observable inputs, outcomes, boundaries, and failure behavior without
  prescribing code structure. Every rule listed here requires automated test coverage.
-->

- **BR-001**: [Business rule with testable normal, boundary, and failure outcomes]

### Sensitive Credentials *(include if applicable)*

<!--
  Identify credential types and required protection behavior without recording any real
  password, token, key, connection secret, or other usable credential. Remove this
  subsection when the feature does not handle credentials.
-->
