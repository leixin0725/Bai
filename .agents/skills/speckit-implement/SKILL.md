...
7. Implementation execution rules:
   ...
   - **Core tests before code**: Every core business rule must have automated tests written before its implementation and covering success, boundary, and critical failure behavior
